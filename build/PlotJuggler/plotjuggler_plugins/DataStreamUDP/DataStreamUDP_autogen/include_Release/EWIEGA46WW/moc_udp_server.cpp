...
#include <memory>
#include "../../../../../../../plotjuggler_plugins/DataStreamUDP/udp_server.h"
...
QT_MOC_LITERAL(1, 11, 14), // "processMessage"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "UDP_Server\0processMessage\0"
};
...
void UDP_Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UDP_Server *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject UDP_Server::staticMetaObject = { {
    QMetaObject::SuperData::link<PJ::DataStreamer::staticMetaObject>(),
    qt_meta_stringdata_UDP_Server.data,
    qt_meta_data_UDP_Server,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    'e',  'r', 
    // "className"
    0x03,  0x6a,  'U',  'D',  'P',  '_',  'S',  'e', 
    'r',  'v',  'e',  'r', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(UDP_Server, UDP_Server)
