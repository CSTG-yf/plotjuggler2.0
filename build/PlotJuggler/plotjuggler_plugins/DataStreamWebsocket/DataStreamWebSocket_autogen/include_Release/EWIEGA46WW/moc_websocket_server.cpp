/****************************************************************************
** Meta object code from reading C++ file 'websocket_server.h'
**
...
#include <memory>
#include "../../../../../../../plotjuggler_plugins/DataStreamWebsocket/websocket_server.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'websocket_server.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 15), // "onNewConnection"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 14), // "processMessage"
QT_MOC_LITERAL(4, 48, 7), // "message"
QT_MOC_LITERAL(5, 56, 18) // "socketDisconnected"

    },
    "WebsocketServer\0onNewConnection\0\0"
    "processMessage\0message\0socketDisconnected"
};
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    'e',  'r', 
    // "className"
    0x03,  0x6f,  'W',  'e',  'b',  's',  'o',  'c', 
    'k',  'e',  't',  'S',  'e',  'r',  'v',  'e', 
    'r', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(WebsocketServer, WebsocketServer)
