...
public:
    ...
    {
        WebSocketDialog->setWindowTitle(QCoreApplication::translate("WebSocketDialog", "WebSocket Server", nullptr));
        label->setText(QCoreApplication::translate("WebSocketDialog", "Port of the Websocket server:", nullptr));
