...
#include <memory>
#include "../../../../../../../plotjuggler_plugins/StatePublisherCSV/publisher_csv.h"
...
void StatePublisherCSV::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StatePublisherCSV *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject StatePublisherCSV::staticMetaObject = { {
    QMetaObject::SuperData::link<PJ::StatePublisher::staticMetaObject>(),
    qt_meta_stringdata_StatePublisherCSV.data,
    qt_meta_data_StatePublisherCSV,
    qt_static_metacall,
    nullptr,
    nullptr
} };
