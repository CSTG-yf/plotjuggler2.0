...
public:
    ...
    {
        ULogParametersDialog->setWindowTitle(QCoreApplication::translate("ULogParametersDialog", "MainWindow", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetInfo->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("ULogParametersDialog", "Property", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetInfo->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("ULogParametersDialog", "Value", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(Info), QCoreApplication::translate("ULogParametersDialog", "Info", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetParams->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("ULogParametersDialog", "Property", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetParams->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("ULogParametersDialog", "Value", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(Properties), QCoreApplication::translate("ULogParametersDialog", "Properties", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidgetLogs->horizontalHeaderItem(0);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("ULogParametersDialog", "Timestamp", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidgetLogs->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("ULogParametersDialog", "Level", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidgetLogs->horizontalHeaderItem(2);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("ULogParametersDialog", "Message", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(Logs), QCoreApplication::translate("ULogParametersDialog", "Message Logs", nullptr));
    } // retranslateUi
