...
public:
    ...
    {
        DialogMultifilePrefix->setWindowTitle(QCoreApplication::translate("DialogMultifilePrefix", "Add prefix", nullptr));
        label->setText(QCoreApplication::translate("DialogMultifilePrefix", "<html><head/><body><p>Specify a prefix to be added to the loaded timeseries:</p></body></html>", nullptr));
    } // retranslateUi
