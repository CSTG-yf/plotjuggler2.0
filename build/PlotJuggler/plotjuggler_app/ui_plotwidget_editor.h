...
public:
    ...
    void setupUi(QDialog *PlotWidgetEditor)
    {
        ...
        PlotWidgetEditor->resize(955, 657);
        ...
        radioSteps = new QRadioButton(frameStyle);
        radioSteps->setObjectName(QString::fromUtf8("radioSteps"));

        verticalLayout_5->addWidget(radioSteps);

        radioStepsInv = new QRadioButton(frameStyle);
        radioStepsInv->setObjectName(QString::fromUtf8("radioStepsInv"));

        verticalLayout_5->addWidget(radioStepsInv);
    ...
    void retranslateUi(QDialog *PlotWidgetEditor)
    {
        ...
        radioSteps->setText(QCoreApplication::translate("PlotWidgetEditor", "Steps (pre)", nullptr));
        radioStepsInv->setText(QCoreApplication::translate("PlotWidgetEditor", "Step (post)", nullptr));
