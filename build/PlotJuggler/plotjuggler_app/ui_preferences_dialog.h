...
public:
    ...
    void setupUi(QDialog *PreferencesDialog)
    {
        ...
        PreferencesDialog->resize(545, 509);
        ...
        verticalLayout_5->addWidget(label1);

        comboBoxPrecision = new QComboBox(frame_3);
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->addItem(QString());
        ...
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->addItem(QString());
        comboBoxPrecision->setObjectName(QString::fromUtf8("comboBoxPrecision"));
        sizePolicy1.setHeightForWidth(comboBoxPrecision->sizePolicy().hasHeightForWidth());
        comboBoxPrecision->setSizePolicy(sizePolicy1);

        verticalLayout_5->addWidget(comboBoxPrecision);
        ...
        groupBoxAutoZoom->setMinimumSize(QSize(0, 0));
        ...
        groupBox_2 = new QGroupBox(behaviorTab);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        verticalLayout_9 = new QVBoxLayout(groupBox_2);
        verticalLayout_9->setObjectName(QString::fromUtf8("verticalLayout_9"));
        checkBoxTruncation = new QCheckBox(groupBox_2);
        checkBoxTruncation->setObjectName(QString::fromUtf8("checkBoxTruncation"));
        checkBoxTruncation->setChecked(true);

        verticalLayout_9->addWidget(checkBoxTruncation);
    ...
    void retranslateUi(QDialog *PreferencesDialog)
    {
        ...
        label1->setText(QCoreApplication::translate("PreferencesDialog", "Float Precision:", nullptr));
        comboBoxPrecision->setItemText(0, QCoreApplication::translate("PreferencesDialog", "0", nullptr));
        comboBoxPrecision->setItemText(1, QCoreApplication::translate("PreferencesDialog", "1", nullptr));
        comboBoxPrecision->setItemText(2, QCoreApplication::translate("PreferencesDialog", "2", nullptr));
        comboBoxPrecision->setItemText(3, QCoreApplication::translate("PreferencesDialog", "3", nullptr));
        comboBoxPrecision->setItemText(4, QCoreApplication::translate("PreferencesDialog", "4", nullptr));
        comboBoxPrecision->setItemText(5, QCoreApplication::translate("PreferencesDialog", "5", nullptr));
        comboBoxPrecision->setItemText(6, QCoreApplication::translate("PreferencesDialog", "6", nullptr));
        comboBoxPrecision->setItemText(7, QCoreApplication::translate("PreferencesDialog", "7", nullptr));
        ...
        groupBox_2->setTitle(QCoreApplication::translate("PreferencesDialog", "Parsing", nullptr));
#if QT_CONFIG(tooltip)
        checkBoxTruncation->setToolTip(QCoreApplication::translate("PreferencesDialog", "<html><head/><body><p>PlotJuggler uses double (64bits) internally.</p><p>This means that integer numbers with more than 52 significant bits <span style=\" font-weight:700;\">can not be represented</span> exactly.</p><p>Disabling this check, you allow static type convertion and accept some degree of  numerical errors. </p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        checkBoxTruncation->setText(QCoreApplication::translate("PreferencesDialog", "Strict Truncation check (uncheck at your own risk)", nullptr));
