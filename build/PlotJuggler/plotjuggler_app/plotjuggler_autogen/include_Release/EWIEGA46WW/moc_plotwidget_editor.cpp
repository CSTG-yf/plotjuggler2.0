...
#include <memory>
#include "../../../../../../plotjuggler_app/plotwidget_editor.h"
...
QT_MOC_LITERAL(19, 366, 22), // "on_radioSticks_toggled"
QT_MOC_LITERAL(20, 389, 21), // "on_radioSteps_toggled"
QT_MOC_LITERAL(21, 411, 24) // "on_radioStepsInv_toggled"
    ...
    "on_radioSticks_toggled\0on_radioSteps_toggled\0"
...
void PlotwidgetEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 13: _t->on_radioSticks_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 14: _t->on_radioSteps_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 15: _t->on_radioStepsInv_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
