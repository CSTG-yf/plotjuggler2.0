...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "releases/cpp/v2.0.0"
  WORKING_DIRECTORY "D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/mcap-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "releases/cpp/v2.0.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("releases/cpp/v2.0.0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: releases/cpp/v2.0.0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/releases/cpp/v2.0.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"releases/cpp/v2.0.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/mcap-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/mcap-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
