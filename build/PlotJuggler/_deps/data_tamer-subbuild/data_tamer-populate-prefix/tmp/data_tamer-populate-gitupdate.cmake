...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "1.0.1"
  WORKING_DIRECTORY "D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/data_tamer-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/data_tamer-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/gitproject/plotjuggler2/build/PlotJuggler/_deps/data_tamer-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
